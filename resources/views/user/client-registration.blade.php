...
<div class="container">
    ...
    <div class="fs-form-wrap" id="fs-form-wrap" style="background-image: url('../images/login-admin.jpg');">
        ...
        <form id="myform" class="fs-form fs-form-full" autocomplete="off" action="{{ url('/client/reg') }}" method="POST">
            {{ csrf_field() }}
            <ol class="fs-fields">
                <li>
                ...
                <li>
                    <label class="fs-field-label fs-anim-upper" for="q3" data-info="We won't send you spam, we promise...">Type your Password</label>
                    <input class="fs-anim-lower" id="q3" name="password" type="password" placeholder="******" required/>
                </li>
                <li>
                    <label class="fs-field-label fs-anim-upper" for="q4" data-info="We won't send you spam, we promise...">What's your phone number?</label>
                    <input class="fs-anim-lower" id="q4" name="phone" type="number" placeholder="+00000000" required/>
                </li>
                <li>
                    <label class="fs-field-label fs-anim-upper" for="q5" data-info="We won't send you spam, we promise...">What's your Birth date?</label>
                    <input class="fs-anim-lower" id="q5" name="date_of_birth" type="date" placeholder="MM/DD/YYYY" required/>
                </li>
            </ol><!-- /fs-fields -->
