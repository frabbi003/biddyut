                    ...
                    <div class="col-md-12">
                        <div class="box box-info">
                            <div class="box-header">
                                <h3 class="box-title">Rider Create</h3>
                                <a href="/pager_parts">
                            ...
                            <div class="box-body pad">
                                <form role="form" action="{{ url('/rider-create') }}" method="POST"
                                      enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="box-body">
                                        <div class="form-group">
                                            <input type="hidden" class="form-control" name="bid_pager_section_id" value="14" readonly>
                                        </div>
